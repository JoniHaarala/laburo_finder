...
const Trabajo = ({
    ...
    <section className="font-[roboto] bg-white dark:bg-gray-800 p-3 rounded-xl grid grid-cols-3 grid-rows-[1fr, min-content] mt-4 w-full md:flex lg:h-40 md:mb-8 lg:max-h-40 md:justify-between md:gap-3">
